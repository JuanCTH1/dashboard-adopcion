...
export function Sidebar({
  ...
  const { lineasNegocio } = filtrosDisponibles;
  ...
  return (
    ...
    >
      ...
      {/* 2. Contenido de Filtros de Contexto Global */}
      {isOpen && (
        <div className="flex-1 flex flex-col min-h-0 overflow-hidden bg-slate-50 dark:bg-slate-950">
          ...
          {/* Lista scrolleable de Bloques Contextuales */}
          <div className="flex-1 overflow-y-auto px-3 py-3 space-y-3.5 text-left scrollbar-thin">
            ...
            {/* TARJETA DE GUÍA: NAVEGACIÓN ORGANIZACIONAL EN EL LIENZO */}
