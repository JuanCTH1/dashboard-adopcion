    ...
    <>
      ...
      {isVisible && (
        <div
          ...
          className="z-[9999] pointer-events-none whitespace-nowrap rounded-lg bg-card/98 dark:bg-slate-900/98 text-foreground px-2.5 py-1 text-[10.5px] font-bold shadow-xl border-2 border-slate-300 dark:border-slate-600 backdrop-blur-md animate-in fade-in-0 zoom-in-95 duration-100"
        >
          {text}
        </div>
      )}
